...
class Detector:
    ...
    def process(self, path):
        ...
        for contour in contours:
            ...
            if area >= Constants.HUMAN_AREA_THRESHOLD:
                ...
                avg = self.calculateAverages(exposedFrame, x, y, w, h)
                ...
                for p in self.people:
                    if Detector.isPersonInRange(avg, p.getAverages()):
                        new = False
    ...
    def calculateAverages(self, frame, x, y, w, h):
        hp = math.floor(h / 3)
    ...
    @staticmethod
    def isPersonInRange(avg, prevAvg):
